<nav class="pt-30 pb-30 bg-dark lh-40 text-center navigation_8">
		<div class="container px-xl-0">
			<div class="row align-items-center">
				<div class="col-lg-3 text-lg-left">
					<a href="index.php" class="link logo color-white">DIMENSION XI</a>
				</div>
				<div class="col-lg-6">
				...
				<div class="mt-10 mt-lg-0 col-lg-3 text-lg-right">
					...
					<a href="signup.php" class="link mr-30 color-white">Sign Up</a>
				</div>
			</div>
		</div>
	</nav>