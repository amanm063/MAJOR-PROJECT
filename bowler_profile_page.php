...
<?php
extract($_REQUEST);
if(isset($_REQUEST['action']) && $action == 'bowler'){
$get_bowler= mysqli_query($conn, "SELECT * FROM `bowlerslink` WHERE id='$bowlerid' ");
    ...
    //   echo $bowler;
    //   echo $link;
      $details= mysqli_query($conn, "SELECT * FROM `bowler_1` WHERE id='$id' "); 
      while($get_bowler_details = mysqli_fetch_array($details)){
      $economy=$get_bowler_details['economy'];
      $wickets=$get_bowler_details['wickets'];
    ...
    <figure class="snip0045 blue">
        <figcaption>
        <h2><span><?php echo $bowlername;  ?></span></h2>
            ...
            <h6>Wicket:<?php echo $wickets ; ?></h6>
            <h6>Economy:<?php echo $economy ; ?></h6>
        </figcaption>
    ...
    <div class='tableauPlaceholder' id='viz1652163277087' style='position: relative'><noscript><a href='#'>
                <img alt=' '
                    src='https:&#47;&#47;public.tableau.com&#47;static&#47;images&#47;JQ&#47;JQY7XCCHQ&#47;1_rss.png'
                    style='border: none' /></a></noscript>
        <object class='tableauViz' style='display:none;'>
            <param name='host_url' value='https%3A%2F%2Fpublic.tableau.com%2F' />
            <param name='embed_code_version' value='3' />
            <param name='path' value='shared&#47;JQY7XCCHQ' />
            <param name='toolbar' value='yes' />
            <param name='static_image'
                value='https:&#47;&#47;public.tableau.com&#47;static&#47;images&#47;JQ&#47;JQY7XCCHQ&#47;1.png' />
